...
class TestTrackPreparation:
    ...
    def test_raise_download_error_no_test_mode_file(self, is_file, ensure_dir, download):
        ...
        download.side_effect = urllib.error.HTTPError(
            "http://benchmarks.elasticsearch.org.s3.amazonaws.com/corpora/unit-test/docs-1k.json", 404, "", None, None  # type: ignore[arg-type]  # TODO remove this ignore when introducing type hints
        )
    ...
    def test_raise_download_error_on_connection_problems(self, is_file, ensure_dir, download):
        ...
        download.side_effect = urllib.error.HTTPError(
            "http://benchmarks.elasticsearch.org/corpora/unit-test/docs.json", 500, "Internal Server Error", None, None  # type: ignore[arg-type]  # TODO remove this ignore when introducing type hints
        )
