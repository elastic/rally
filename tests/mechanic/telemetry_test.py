...
class NodeStatsRecorderTests(TestCase):
    ...
    def test_stores_default_nodes_stats(self, metrics_store_put_value, metrics_store_put_count):
        ...
        metrics_store_put_count.assert_has_calls([
            mock.call(node_name="rally0", name="thread_pool_generic_threads", count=4, meta_data=metrics_store_meta_data),
            mock.call(node_name="rally0", name="thread_pool_generic_queue", count=0, meta_data=metrics_store_meta_data),
            mock.call(node_name="rally0", name="thread_pool_generic_active", count=0, meta_data=metrics_store_meta_data),
            mock.call(node_name="rally0", name="thread_pool_generic_rejected", count=0, meta_data=metrics_store_meta_data),
            mock.call(node_name="rally0", name="thread_pool_generic_largest", count=4, meta_data=metrics_store_meta_data),
            mock.call(node_name="rally0", name="thread_pool_generic_completed", count=8, meta_data=metrics_store_meta_data),
            mock.call(node_name="rally0", name="breaker_parent_overhead", count=1.0, meta_data=metrics_store_meta_data),
            mock.call(node_name="rally0", name="breaker_parent_tripped", count=0, meta_data=metrics_store_meta_data),
            mock.call(node_name="rally0", name="jvm_buffer_pool_mapped_count", count=7, meta_data=metrics_store_meta_data),
            mock.call(node_name="rally0", name="jvm_buffer_pool_direct_count", count=6, meta_data=metrics_store_meta_data),
        ], any_order=True)
        ...
        metrics_store_put_value.assert_has_calls([
            ...
            mock.call(node_name="rally0", name="breaker_parent_estimated_size_in_bytes", value=0, unit="byte", meta_data=metrics_store_meta_data),
