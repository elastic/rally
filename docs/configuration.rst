...
* ``datastore.overwrite_existing_templates`` (default: ``false``): Existing Rally index teplates, component templates and ilm policies are replaced only when this option is ``true``.
