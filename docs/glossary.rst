...
.. glossary::
    ...
    track
        A track is the description of one ore more benchmarking scenarios with a specific document corpus. It defines for example the involved indices, data files and which operations are invoked. List the available tracks with ``esrally list tracks``. Although Rally ships with some tracks out of the box, you should usually :doc:`create your own track</adding_tracks>` based on your own data.
